               ...
               <div class="container">
                   <div class="row">
                       <div class="col-lg-7 order-lg-1 order-2 banner-content">
                           ...
                           <h1 class="text-uppercase">This is Rong Krishi</h1>
                           <h5 class="text-uppercase">Agricultural Goods Manufacturarers</h5>
                           <div class="mt-5">
               ...
               <div class="container">
                   <div class="row align-items-center">
                       ...
                       <div class="col-lg-5 mb-4 mb-lg-0">
                           ...
                           <a href="Anup_Banskota_Resume.pdf" class="main-btn primary-btn mt-4">Learn More</a>
                       </div>
                   </div>
