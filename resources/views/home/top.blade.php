               ...
               <div class="container">
                   <div class="row">
                       <div class="col-lg-7 order-lg-1 order-2 banner-content">
                           <h2 class="text-uppercase position-relative">Welcome </h2>
                       ...
                       <div class="col-lg-5 order-lg-2 order-1">
                           <div class="top-right-img">
                               <img src="/images/banner3.jpg" class="img-fluid" style="opacity: 0.75;">
                           </div>
                       </div>
                   </div>
               </div>
               ...
               <div class="container">
                   <div class="row align-items-center">
                       <div class="col-lg-7 mb-4 mb-lg-0">
                           <img src="images/banner1.jpg" class="img-fluid" alt="about-us" style="opacity: 0.85;">
                       </div>
                       ...
                       <div class="offset-lg-2 col-lg-4 col-md-10">
                           <div class="client-info">
                               <div class="d-flex">
                                   ...
                                   <span class="smll">Year <br>INTO <br>Working</span>
                               </div>
